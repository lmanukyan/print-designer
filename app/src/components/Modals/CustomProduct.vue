              ...
              <div class="row justify-center">
                <div class="col-4 q-mr-sm">
                  <q-card class="my-card">
                    <q-item>
                      <q-item-section>
                        <q-item-label>Передняя <span class="text-negative">(Обязательно)</span> </q-item-label>
                      </q-item-section>
                    </q-item>
                    ...
                    <q-card-actions align="center">
                      <input ref="frontImage" type="file" @change="uploadImage('front', $event)" accept="image/*" class="hidden" />
                      <q-btn @click="this.$refs.frontImage.click()" color="secondary">Выбрать</q-btn>
                    </q-card-actions>
                  </q-card>
                </div>
                <div class="col-4 q-ml-sm">
                  <q-card class="my-card">
                    ...
                    <q-card-actions align="center">
                      <input ref="backImage" type="file" @change="uploadImage('back', $event)" accept="image/*" class="hidden" />
                      <q-btn @click="this.$refs.backImage.click()" color="secondary">Выбрать</q-btn>
                    </q-card-actions>
                  </q-card>
                </div>
              </div>

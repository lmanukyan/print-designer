<template>
    ...
    <q-dialog v-model="confirmModal" persistent>
      <q-card>
        ...
        <q-card-actions align="right">
          ...
          <q-btn flat label="Да" color="primary" v-close-popup @click="deleteProjectAsync" />
        </q-card-actions>
      </q-card>
    </q-dialog>
    ...
    <q-dialog v-model="newProjectModal" persistent>
      <q-card style="min-width: 350px">
        ...
        <q-card-actions align="right">
          ...
          <q-btn flat label="сохранить" color="primary" v-close-popup @click="saveAs" />
        </q-card-actions>
      </q-card>
    </q-dialog>
  ...
  <template v-else>
    <p>Чтобы сохранить/загрузить проект нужно <span @click="setAuthModalOpened(true)" class="text-primary cursor-pointer">авторизоваться.</span></p>
  </template>
